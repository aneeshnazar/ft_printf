...
/*   Updated: 2017/08/17 14:22:58 by anazar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	get_digit(unsigned long long n)
{
	if (n <= 9)
		return (n + '0');
	else
...
static void	help(char *buffer, int base, unsigned long long num, int index)
{
...
char		*ft_llutoa(unsigned long long n, char base)
{
	int		len;
	char	*buffer;
	int		b;

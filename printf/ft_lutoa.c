...
/*   Updated: 2017/08/17 14:37:40 by anazar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	ft_intlen(unsigned long n, int base)
{
	int		i;
...
static char	get_digit(unsigned long n)
{
	if (n <= 9)
		return (n + '0');
	else
...
static void	help(char *buffer, int base, unsigned long num, int index)
{

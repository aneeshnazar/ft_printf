...
/*   Updated: 2017/08/17 14:23:10 by anazar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	ft_intlen(size_t n, int base)
{
	int		i;
...
static char	get_digit(size_t n)
{
	if (n <= 9)
		return (n + '0');
	else
...
static void	help(char *buffer, int base, size_t num, int index)
{
